...
# 根据时间段抓取美元指数
def get_usd_index(i_type, i_count):
    url_pattern = 'https://forexdata.wallstreetcn.com/kline?prod_code=USDOLLARINDEX&candle_period=' \
                 + str(i_type) + \
...
get_usd_index(data_type, data_count)
